            ...
            <div class="card mb-3" style="width:inherit;height: auto; margin-right: 80px;margin-left:20px;">
                <div class="row no-gutters">
                    ...
                    <div class="col-md-2" style="margin-top: 120px;">
                        <button class="ml-auto btn btn-primary text-uppercase" type="button" name="button_call" style="border-radius:13px;font-size:13px;background-color:#033D68;border-color:#033D68;"> <a href="#"></a> Jadwal Dokter</button>
                    </div>
                </div>
            </div>
        </div>
